...
const receivedChequesLists = [
  ...
  { title: "خرج شده", receivedChequeStatus: 10, soon: true },
              ...
              {filteredCheques && filteredCheques.length > 0 ? (
                filteredCheques.map((row) => (
                  <React.Fragment key={row.id}>
                    <div
                      className={`relative grid grid-cols-8 items-center bg-[rgba(255,255,255,0.6)] text-sm [&_div]:p-2 ps-6 text-center pe-5 [&_div]:overflow-hidden [&_div]:text-ellipsis cursor-pointer py-3`}
