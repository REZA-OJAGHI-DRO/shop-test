...
function Button({type , value , click , styleButton , icon}) {
  const style = {
    ...
    style23:' w-[100%] h-[35px] bg-custom-green shadow-custom-6 px-2 hover:scale-95  transition-all duration-300 text-zinc-100 rounded-md text-[1rem] flex justify-center items-center',
    style24:' w-[100%] h-[35px] bg-[#B27BFF] shadow-inner-custom-2 px-2 text-white rounded-md text-[.8rem] flex justify-center items-center',
  }
  return (
    // <div className='bg-custom-bg-2'></div>
    <button type={type ? type : "button"} onClick={click} className= {styleButton==1?style.style1 : styleButton == 2?style.style2 : styleButton == 3? style.style3 :styleButton == 4? style.style4 :styleButton ==5? style.style5 :styleButton ==6?style.style6:styleButton ==7?style.style7:styleButton ==8?style.style8:styleButton ==9?style.style9:styleButton ==10?style.style10:styleButton ==11?style.style11:styleButton ==12?style.style12:styleButton ==13?style.style13:styleButton ==14?style.style14:styleButton ==15?style.style15:styleButton ==16?style.style16:styleButton ==17?style.style17:styleButton ==18?style.style18:styleButton ==19?style.style19:styleButton ==20?style.style20:styleButton ==21?style.style21:styleButton ==22?style.style22:styleButton ==23?style.style23:style.style24 }>{value}  <Icon icon='typcn:plus' className={`${icon==true?'flex':'hidden'}`}></Icon></button>
  )
}
