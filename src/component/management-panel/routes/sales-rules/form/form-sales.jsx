  ...
  const onSubmit = async (dataAll) => {
    ...
    const updatedDataAll = {
      data: {
        ...
        paymentDurationDays: Number(dataAll?.paymentDurationDays) || null,
        amountMaxLimit: Number(dataAll?.amountMaxLimit) || null,
        amountMinLimit: Number(dataAll?.amountMinLimit) || null,
        costMinLimit: Number(dataAll?.costMinLimit) || null,
        shopperRankLimit: Number(dataAll?.shopperRankLimit) || null,
        invoiceDiscountPercent: Number(dataAll?.invoiceDiscountPercent) || null,
        goodDiscountPercent: Number(dataAll?.goodDiscountPercent) || null,
