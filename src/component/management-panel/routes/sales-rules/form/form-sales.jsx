  ...
  const onSubmit = async (dataAll) => {
    ...
    const updatedDataAll = {
      data: {
        ...
        shopperRankLimit: Number(
          dataAll?.shopperRankLimit.toLocaleString("en-US")
        ),
        invoiceDiscountPercent: Number(
          dataAll?.invoiceDiscountPercent.toLocaleString("en-US")
        ),
        goodDiscountPercent: Number(
          dataAll?.goodDiscountPercent.toLocaleString("en-US")
        ),
