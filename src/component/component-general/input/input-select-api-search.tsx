...
const InputSelectApiSearch = forwardRef(
  ({ options, data, setData, disabled , setSearchData }, ref) => {
    ...
    const handleBackspace = (value) => {
      if (value.length < 3) {
        ...
        const lastMultipleOfThree = value.slice(0, Math.floor(value.length / 3) * 3);
        setSearchData(lastMultipleOfThree); 
      }
    };
...
export default InputSelectApiSearch;
