export const SuggestionCreate = async ({ updatedDataAll: { data, token, chabk, setMessage } }) => {
    const url = `https://${chabk}/Preferences/Suggestion/Create`;
  ...
  export async function AdminSuggestionsGetList(
    dataAll,
    token,
    chabk,
    setMessageData,
    ...
    const url = `https://${chabk}/Preferences/Suggestion/GetList`;
