...
interface FormValues {
  title: string;
  price: string;
  discountType: number; // مقدار انتخاب‌شده برای نوع تخفیف
}
...
const FormDiscount: React.FC<FormDiscountProps> = ({
  ...
  const [discountType, setDiscountType] = useState<number | undefined>(type); // مدیریت مقدار چک‌باکس
