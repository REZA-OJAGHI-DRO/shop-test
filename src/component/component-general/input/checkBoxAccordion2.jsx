...
function checkBoxAccordion2({ label, isChecked, onCheck }) {
    return (
        <>
          <div onClick={() => onCheck()} className="w-full cursor-pointer h-[40px] xl:h-[40px]  flex justify-center bg-[#E4E4E4] px-2 rounded-xl items-center ">
            <div
...
export default checkBoxAccordion2
