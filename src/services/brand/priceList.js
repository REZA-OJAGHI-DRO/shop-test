export async function PriceListGetList(
    dataAll,
    token,
    chabk,
    setMessageData,
    ...
    const url = `https://${chabk}/Product/PriceList/GetList`;
...
// *******
export const PriceListCreate = async ({ updatedDataAll: { data, token, chabk, setMessage } }) => {
    const url = `https://${chabk}/Product/PriceList/Create`;
...
export async function PriceListToggle(
    id,
     token,
      chabk,
      setCheckDataAll,
    ...
    const url = `https://${chabk}/Product/PriceList/Toggle`;
...
export const PriceListUpdate = async ({ updatedDataAll: { data, token, chabk, setMessage } }) => {
    const url = `https://${chabk}/Product/PriceList/Update`;
